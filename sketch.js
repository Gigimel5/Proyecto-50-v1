...
function preload() {//Precarga
  ...
  l = loadAnimation("assets/lava0.2.png", "assets/lava1.2.png", "assets/lava2.2.png", "assets/lava3.2.png", "assets/lava4.2.png", "assets/lava5.2.png");

  g1a = loadImage("assets/gema1_azul.png");

  /*
  g2a = loadImage("assets/gema2_azul.png");
  g3a = loadImage("assets/gema3_azul.png");
